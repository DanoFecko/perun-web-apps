...
export class UsersManagerService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public deleteUser(user: number, force: boolean, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<any>;
    public deleteUser(user: number, force: boolean, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpResponse<any>>;
    public deleteUser(user: number, force: boolean, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpEvent<any>>;
    public deleteUser(user: number, force: boolean, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json'}): Observable<any> {
        if (user === null || user === undefined) {
            throw new Error('Required parameter user was null or undefined when calling deleteUser.');
        }
        if (force === null || force === undefined) {
            throw new Error('Required parameter force was null or undefined when calling deleteUser.');
        }
     ...
     * @param sourceUser id of User
     * @param targetUser id of User
     * @param userExtSource id user ext source
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public moveUserExtSource(sourceUser: number, targetUser: number, userExtSource: number, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<any>;
    public moveUserExtSource(sourceUser: number, targetUser: number, userExtSource: number, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpResponse<any>>;
    public moveUserExtSource(sourceUser: number, targetUser: number, userExtSource: number, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json'}): Observable<HttpEvent<any>>;
    public moveUserExtSource(sourceUser: number, targetUser: number, userExtSource: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json'}): Observable<any> {
        if (sourceUser === null || sourceUser === undefined) {
            throw new Error('Required parameter sourceUser was null or undefined when calling moveUserExtSource.');
        }
        if (targetUser === null || targetUser === undefined) {
            throw new Error('Required parameter targetUser was null or undefined when calling moveUserExtSource.');
        }
        if (userExtSource === null || userExtSource === undefined) {
            throw new Error('Required parameter userExtSource was null or undefined when calling moveUserExtSource.');
        }
        ...
        return this.httpClient.post<any>(`${this.configuration.basePath}/urlinjsonout/usersManager/moveUserExtSource`,
            null,
            {
                params: queryParameters,
                responseType: <any>responseType,
